...
class GenerateAdminUser extends Command {
     ...
     * @var string
     */
    protected $name = 'admin-module:generate:admin-user';
     ...
     * @var string
     */
    protected $description = 'Scaffold complete admin CRUD for specified admin user model from admin-auth package. This differs from admin-module:generate command in many additional features (password handling, roles, ...).';
