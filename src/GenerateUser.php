...
class GenerateUser extends Command
{
     ...
     * @var string
     */
    protected $name = 'admin-module:generate:user';
     ...
     * @var string
     */
    protected $description = 'Scaffold complete admin CRUD for specified user model. This differs from admin-module:generate command in many additional features (password handling, roles, ...).';
