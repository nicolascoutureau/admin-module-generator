...
abstract class FileAppender extends Command
{
    ...
    {
        $this->initCommonNames($this->argument('table_name'), $this->argument('module_name'), $this->option('model-name'), $this->option('controller-name'), $this->option('model-with-full-namespace'));
