...
class ViewIndex extends ViewGenerator
{
     ...
     * @var string
     */
    protected $name = 'admin-module:generate:index';
    ...
    public function handle()
    {
        ...
        $viewPath = module_path($this->moduleName, 'Resources/views/admin/' . $this->modelViewsDirectory . '/index.blade.php');
        $listingJsPath = module_path($this->moduleName, 'Resources/assets/js/admin/' . $this->modelJSName . '/Listing.js');
