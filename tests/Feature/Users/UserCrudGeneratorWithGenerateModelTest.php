...
class UserCrudGeneratorWithGenerateModelTest extends UserTestCase
{
    ...
    public function user_model_name_should_auto_generate_from_table_name_if_required(): void
    {
        ...
        $this->artisan('admin-module:generate:user', [
            '--generate-model' => true
        ]);
...
use Elifbyte\AdminAuth\Activation\Contracts\CanActivate as CanActivateContract;
use Elifbyte\AdminAuth\Activation\Traits\CanActivate;
use Elifbyte\AdminAuth\Notifications\ResetPassword;
