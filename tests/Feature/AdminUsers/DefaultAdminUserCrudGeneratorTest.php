...
namespace Elifbyte\AdminGenerator\Tests\Feature\Users;

use Elifbyte\AdminGenerator\Tests\UserTestCase;
...
class DefaultAdminUserCrudGeneratorTest extends UserTestCase
{
    ...
    public function all_files_should_be_generated_under_default_namespace(): void
    {
        ...
        $this->artisan('admin-module:generate:admin-user');
...
use Elifbyte\AdminAuth\Models\AdminUser;
use Spatie\Permission\Models\Role;
use Elifbyte\AdminAuth\Activation\Facades\Activation;
use Elifbyte\AdminAuth\Services\ActivationService;
use Elifbyte\AdminListing\Facades\AdminListing;
use Exception;
...
$factory->define(Elifbyte\AdminAuth\Models\AdminUser::class', File::get($factoryPath));
    }
