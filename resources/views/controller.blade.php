...
@if(!$withoutBulk)
use {{$moduleNamespace}}\Http\Requests\Admin\{{ $modelWithNamespaceFromDefault }}\BulkDestroy{{ $modelBaseName }};
@endif
use {{$moduleNamespace}}\Http\Requests\Admin\{{ $modelWithNamespaceFromDefault }}\Destroy{{ $modelBaseName }};
use {{$moduleNamespace}}\Http\Requests\Admin\{{ $modelWithNamespaceFromDefault }}\Index{{ $modelBaseName }};
use {{$moduleNamespace}}\Http\Requests\Admin\{{ $modelWithNamespaceFromDefault }}\Store{{ $modelBaseName }};
use {{$moduleNamespace}}\Http\Requests\Admin\{{ $modelWithNamespaceFromDefault }}\Update{{ $modelBaseName }};
use {{ $modelFullName }};
...
@endif
        ...
        return view('{{$moduleName}}::admin.{{ $modelDotNotation }}.index', ['data' => $data]);
    }
...
@if (count($relations) && count($relations['belongsToMany']))
        return view('{{$moduleName}}::admin.{{ $modelDotNotation }}.create',[
@foreach($relations['belongsToMany'] as $belongsToMany)
...
@endif
@endif
        return view('{{$moduleName}}::admin.{{ $modelDotNotation }}.edit', [
