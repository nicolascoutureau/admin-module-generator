...
{{'@'}}section('title', trans('{{$moduleName}}::admin.{{ $modelLangFormat }}.actions.edit_profile'))
            ...
            <{{ $modelJSName }}-form
                ...
                <form class="form-horizontal form-edit" method="post" {{'@'}}submit.prevent="onSubmit" :action="action">
                    ...
                    <div class="card-header">
                        <i class="fa fa-pencil"></i> {{'{{'}} trans('{{$moduleName}}::admin.{{ $modelLangFormat }}.actions.edit_profile') }}
                    </div>
